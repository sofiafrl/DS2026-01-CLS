...
// Phase 2 defines four base voice profiles to simulate fugue registers:
// soprano, alto, tenor, and bass. Extra voices cycle through these profiles.
...
export function getVoiceProfile(voiceIndex) {
...
export function clampInstrument(program) {
	return Math.max(
